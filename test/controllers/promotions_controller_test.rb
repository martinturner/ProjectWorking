...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { description: @promotion.description, name: @promotion.name, point_cost: @promotion.point_cost }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { description: @promotion.description, name: @promotion.name, point_cost: @promotion.point_cost }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
